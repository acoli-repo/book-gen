...
def clean_text_by_sentences(text, language="english"):
    ...
    #original_sentences = read_already_split_sentences()
    # modified: July 16th
    # text is now a list of list of tokens
    original_sentences = [' '.join(tokens) for tokens in text] 
    #original_sentences = split_sentences(text)
    #print("original sentences")
    #print(original_sentences)
    # TODO: try: feed original_sentences as tokenized already.
